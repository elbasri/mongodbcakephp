...
namespace Nacer\Mongodbcakephp\Database;

use Cake\Database\Exception\MissingConnectionException;
use Nacer\Mongodbcakephp\Database\Driver\Mongodb as Nacerdb;
use Nacer\Mongodbcakephp\Database\Schema\MongoSchema;
...
class Connection extends \Cake\Database\Connection
{
     ...
     *
     * @var \Nacer\Mongodbcakephp\Database\Driver\Mongodb;
     */
    ...
    public function driver($driver = null, $config = [])
    {
        ...
        $this->_driver = new Nacerdb($config);
