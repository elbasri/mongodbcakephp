...
namespace Nacer\Mongodbcakephp\ORM;
...
class Table extends CakeTable
{
    ...
    private function __getCollection()
    {
        ...
        if (!$driver instanceof \Nacer\Mongodbcakephp\Database\Driver\Mongodb) {
            throw new \Exception("Driver must be an instance of 'Nacer\Mongodbcakephp\Database\Driver\Mongodb'");
        }
